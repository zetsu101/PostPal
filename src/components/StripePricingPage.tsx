          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">AI-Generated Posts</td>
                  <td className="text-center py-4 px-6">5/month</td>
                  <td className="text-center py-4 px-6">Unlimited</td>
                  <td className="text-center py-4 px-6">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">Social Media Accounts</td>
                  <td className="text-center py-4 px-6">2</td>
                  <td className="text-center py-4 px-6">Unlimited</td>
                  <td className="text-center py-4 px-6">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">Analytics</td>
                ...
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">Content Scheduling</td>
                  <td className="text-center py-4 px-6">❌</td>
                  <td className="text-center py-4 px-6">✅</td>
                  <td className="text-center py-4 px-6">✅</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">Team Collaboration</td>
                  <td className="text-center py-4 px-6">❌</td>
                  <td className="text-center py-4 px-6">✅</td>
                  <td className="text-center py-4 px-6">✅</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">API Access</td>
                  <td className="text-center py-4 px-6">❌</td>
                  <td className="text-center py-4 px-6">❌</td>
                  <td className="text-center py-4 px-6">✅</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 text-gray-900 font-medium">Support</td>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-left">
              ...
              <p className="text-gray-600">Yes! Our free plan includes 5 AI-generated posts per month with no credit card required.</p>
            </div>
            ...
            <div className="text-left">
              ...
              <p className="text-gray-600">Absolutely! Cancel anytime with no cancellation fees. Your plan remains active until the end of your billing period.</p>
            </div>
          </div>
        </motion.div>
      </div>
